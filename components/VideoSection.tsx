const VideoSection = () => {
  return (
    <section className="w-full flex items-center py-12 px-6 lg:px-24 min-h-[37.5rem] bg-alt-sections-bg">
      <div className="max-w-7xl h-full flex flex-col w-full lg:flex-row justify-center items-center lg:gap-12 mx-auto">
